...
- To run either teh Mac OS or Windows executable, navigate to the directory containing the executable.  Double-click to open the executable.  This should open the GUI window described below and start the application.
